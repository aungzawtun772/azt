...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/AungZawTun007/star/blob/main/Paid.txt').text
...
\033[1;96m------------------WELCOME BABY-------------------\033[0m""")
  ...
  print(f"")
  try:
    httpCaht = requests.get("https://github.com/AungZawTun007/star/blob/main/Paid.txt").text
    if id in httpCaht:
